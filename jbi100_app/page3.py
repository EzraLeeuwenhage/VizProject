...
plot_month = TenaryScatter("Tenary plot thingy month", cdf)
plot_year = TenaryScatter("Tenary plot thingy year", cdf)
...
def update_plot(type1, value1, type2, value2, type3, value3):
    return plot_month.update([type1, type2, type3], [value1, value2, value3], 'year')
...
def update_plot2(type1, value1, type2, value2, type3, value3):
    return plot_year.update([type1, type2, type3], [value1, value2, value3])
    ...
    def make_cat_menu(number):
        return html.Div(
            children=[
                ...
                # TODO: put 2 dropdowns on one line (impossible)
                dcc.Dropdown(
